# Packet
1. CISPP Glossary - Student Guide
   - Representation of data at Layer 3 of the Open Systems Interconnection (OSI) model. https://www.isc2.org/certifications/cissp/cissp-student-glossary
...
2. SANS Glossary of Cyber Security Terms
   - A piece of a message transmitted over a packet-switching network. One of the key features of a packet is that it contains the destination address in addition to the data. In IP networks, packets are often called datagrams. https://www.sans.org/security-resources/glossary-of-terms/
